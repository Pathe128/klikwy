...
export default function EditProjectPage() {
  ...
  useEffect(() => {
    const loadProject = () => {
      try {
        ...
        const projectToEdit = savedProjects.find((p: any) => p.id === id)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!session) {
      setError('Veuillez vous connecter pour modifier un projet')
      return
    }
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#0D3B66]"></div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <button
            onClick={() => router.back()}
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#0D3B66] hover:bg-[#0a2e4d] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F72585]"
          >
            ...
            <div className="pt-4 border-t border-gray-200">
              <div className="flex justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#0D3B66] hover:bg-[#0a2e4d] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F72585] disabled:opacity-50 disabled:cursor-not-allowed"
                >
